package stockalarm.integration;
...
import stockalarm.clients.stockapi.alphavantage.Alphavantage;
...
public class TestAlphavantageAPI {
    ...
    public void getPrice_ValidAPI_Returns100p1234() throws JsonProcessingException, InterruptedException {
        ...
        Assertions.assertEquals("/?function=TIME_SERIES_INTRADAY&symbol=VALID_SYMBOL&interval=1min&outputsize=compact&apikey=I5TPWWHJJDCQ47IZ",
                recordedRequest.getPath());
        Assertions.assertEquals(mockPrice, returnedPrice);
    }
    ...
    public void getPrice_ValidAPIValue0_Returns0() throws JsonProcessingException, InterruptedException {
        ...
        RecordedRequest recordedRequest = mockWebServer.takeRequest();
        Assertions.assertEquals("GET", recordedRequest.getMethod());
        Assertions.assertEquals("/?function=TIME_SERIES_INTRADAY&symbol=TEST_SYMBOL&interval=1min&outputsize=compact&apikey=I5TPWWHJJDCQ47IZ",
                recordedRequest.getPath());
        Assertions.assertEquals(mockPrice, returnedPrice);
    }
    ...
    public void getPrice_InvalidValue_Returns0() throws JsonProcessingException, InterruptedException {
        ...
        Assertions.assertEquals("/?function=TIME_SERIES_INTRADAY&symbol=TEST_SYMBOL&interval=1min&outputsize=compact&apikey=I5TPWWHJJDCQ47IZ",
                recordedRequest.getPath());
        Assertions.assertEquals(Double.valueOf(0), returnedPrice);
    }
